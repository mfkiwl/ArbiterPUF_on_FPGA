...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { switch_lfsr }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { sel[3] }]; #IO_L24P_T3_35 Sch=sw[12]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { reset_lfsr }]; #IO_L4N_T0_D05_14 Sch=btnu
